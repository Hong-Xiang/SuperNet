...
class SuperNet(object):
    ...
    def __init__(self):
        ...
        self._residual_reference = layer.crop_layer(self._residual_full,
                                                    [FLAGS.valid_h,
                                                     FLAGS.valid_w],
                                                    [FLAGS.valid_y,
                                                     FLAGS.valid_x],
        ...
        crop_low_res = layer.crop_layer(self._low_res_images,
                                        [FLAGS.valid_h,
                                         FLAGS.valid_w],
                                        [FLAGS.valid_y,
                                         FLAGS.valid_x],
        ...
        self._high_res_images = tf.add(crop_low_res,
        ...
        # conv9 = layer.conv_layer(conv8, kernel_shape, name="full_connect")
        ...
        # self._residual_inference = layer.output_layer(conv13,
        #                                               [1, 1, n_channel, 1],
        #                                               name="output")
        ...
        self._residual_inference = layer.output_layer(conv2,
                                                      [k2, k2, n_channel_2, 1],
                                                      padding="VALID",
                                                      name="output")

        # self._residual_inference = self._residual_reference

        self._loss = layer.l2_loss_layer(self._residual_reference,
                                         self._residual_inference,
                                         name="loss")

        self._inference_image = tf.add(crop_low_res,
                                       self._residual_reference,
